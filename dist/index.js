...
var escapeHtml = (str) => str.replace(/[&<>"']/g, (char) => replacements[char]);

// node_modules/@lit-labs/ssr/lib/element-renderer.js
var getElementRenderer = ({ elementRenderers }, tagName, ceClass = customElements.get(tagName), attributes = /* @__PURE__ */ new Map()) => {
  if (ceClass === void 0) {
...
var ElementRenderer = class {
  ...
  *renderAttributes() {
    if (this.element !== void 0) {
      ...
      for (let i6 = 0, name, value; i6 < attributes.length && ({ name, value } = attributes[i6]); i6++) {
...
var o = class {
  ...
  get styleSheet() {
    ...
    if (e && void 0 === t5) {
      ...
      e7 && (t5 = n.get(s6)), void 0 === t5 && ((this.o = t5 = new CSSStyleSheet()).replaceSync(this.cssText), e7 && n.set(s6, t5));
    }
    return t5;
  }
  toString() {
...
var S = (s6, n7) => {
  e ? s6.adoptedStyleSheets = n7.map((t5) => t5 instanceof CSSStyleSheet ? t5 : t5.styleSheet) : n7.forEach((e7) => {
    const n8 = document.createElement("style"), o6 = t.litNonce;
    void 0 !== o6 && n8.setAttribute("nonce", o6), n8.textContent = e7.cssText, s6.appendChild(n8);
  });
};
...
var d = class extends HTMLElement {
  ...
  static get observedAttributes() {
    ...
    return this.elementProperties.forEach((i6, s6) => {
      const e7 = this._$Ep(s6, i6);
      void 0 !== e7 && (this._$Ev.set(e7, s6), t5.push(e7));
    }), t5;
  }
  static createProperty(t5, i6 = l) {
    if (i6.state && (i6.attribute = false), this.finalize(), this.elementProperties.set(t5, i6), !i6.noAccessor && !this.prototype.hasOwnProperty(t5)) {
      const s6 = "symbol" == typeof t5 ? Symbol() : "__" + t5, e7 = this.getPropertyDescriptor(t5, s6, i6);
  ...
  static getPropertyDescriptor(t5, i6, s6) {
    return { get() {
      ...
      const r5 = this[t5];
      this[i6] = e7, this.requestUpdate(t5, r5, s6);
  ...
  _$EO(t5, i6, s6 = l) {
    ...
    if (void 0 !== r5 && true === s6.reflect) {
      const h4 = (void 0 !== (null === (e7 = s6.converter) || void 0 === e7 ? void 0 : e7.toAttribute) ? s6.converter : n2).toAttribute(i6, s6.type);
      this._$El = t5, null == h4 ? this.removeAttribute(r5) : this.setAttribute(r5, h4), this._$El = null;
    }
  }
  _$AK(t5, i6) {
    var s6;
    const e7 = this.constructor, r5 = e7._$Ev.get(t5);
    if (void 0 !== r5 && this._$El !== r5) {
      const t6 = e7.getPropertyOptions(r5), h4 = "function" == typeof t6.converter ? { fromAttribute: t6.converter } : void 0 !== (null === (s6 = t6.converter) || void 0 === s6 ? void 0 : s6.fromAttribute) ? t6.converter : n2;
      this._$El = r5, this[r5] = h4.fromAttribute(i6, t6.type), this._$El = null;
    }
  }
  requestUpdate(t5, i6, s6) {
    let e7 = true;
    void 0 !== t5 && (((s6 = s6 || this.constructor.getPropertyOptions(t5)).hasChanged || a)(this[t5], i6) ? (this._$AL.has(t5) || this._$AL.set(t5, i6), true === s6.reflect && this._$El !== t5 && (void 0 === this._$EC && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t5, s6))) : e7 = false), !this.isUpdatePending && e7 && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
var w = (t5) => (i6, ...s6) => ({ _$litType$: t5, strings: i6, values: s6 });
var x = w(1);
var b = w(2);
...
var P = (t5, i6) => {
  ...
  let r5, d4 = 2 === i6 ? "<svg>" : "", u3 = f;
  for (let i7 = 0; i7 < s6; i7++) {
    const s7 = t5[i7];
    let e7, c5, v3 = -1, a3 = 0;
    for (; a3 < s7.length && (u3.lastIndex = a3, c5 = u3.exec(s7), null !== c5); )
      a3 = u3.lastIndex, u3 === f ? "!--" === c5[1] ? u3 = _ : void 0 !== c5[1] ? u3 = m : void 0 !== c5[2] ? (y.test(c5[2]) && (r5 = RegExp("</" + c5[2], "g")), u3 = p) : void 0 !== c5[3] && (u3 = p) : u3 === p ? ">" === c5[0] ? (u3 = null != r5 ? r5 : f, v3 = -1) : void 0 === c5[1] ? v3 = -2 : (v3 = u3.lastIndex - c5[2].length, e7 = c5[1], u3 = void 0 === c5[3] ? p : '"' === c5[3] ? $ : g) : u3 === $ || u3 === g ? u3 = p : u3 === _ || u3 === m ? u3 = f : (u3 = p, r5 = void 0);
    const w2 = u3 === p && t5[i7 + 1].startsWith("/>") ? " " : "";
    d4 += u3 === f ? s7 + h2 : v3 >= 0 ? (l6.push(e7), s7.slice(0, v3) + o3 + s7.slice(v3) + n3 + w2) : s7 + n3 + (-2 === v3 ? (l6.push(void 0), i7) : w2);
  }
  const c4 = d4 + (t5[s6] || "<?>") + (2 === i6 ? "</svg>" : "");
  ...
  constructor({ strings: t5, _$litType$: i6 }, e7) {
    ...
    for (; null !== (h4 = C.nextNode()) && v3.length < c4; ) {
      if (1 === h4.nodeType) {
        if (h4.hasAttributes()) {
          const t6 = [];
          for (const i7 of h4.getAttributeNames())
            if (i7.endsWith(o3) || i7.startsWith(n3)) {
              const s6 = f2[u3++];
              if (t6.push(i7), void 0 !== s6) {
                const t7 = h4.getAttribute(s6.toLowerCase() + o3).split(n3), i8 = /([.?@])?(.*)/.exec(s6);
                v3.push({ type: 1, index: r5, name: i8[2], strings: t7, ctor: "." === i8[1] ? k : "?" === i8[1] ? I : "@" === i8[1] ? L : R });
              } else
                v3.push({ type: 6, index: r5 });
            }
          for (const i7 of t6)
            h4.removeAttribute(i7);
        }
        if (y.test(h4.tagName)) {
          const t6 = h4.textContent.split(n3), i7 = t6.length - 1;
          if (i7 > 0) {
            h4.textContent = s3 ? s3.emptyScript : "";
            for (let s6 = 0; s6 < i7; s6++)
              h4.append(t6[s6], d2()), C.nextNode(), v3.push({ type: 2, index: ++r5 });
            h4.append(t6[i7], d2());
          }
        }
        ...
        if (h4.data === l2)
          ...
          for (; -1 !== (t6 = h4.data.indexOf(n3, t6 + 1)); )
            v3.push({ type: 7, index: r5 }), t6 += n3.length - 1;
        }
      r5++;
    }
  }
...
function N(t5, i6, s6 = t5, e7) {
  var o6, n7, l6, h4;
  if (i6 === T)
    return i6;
  let r5 = void 0 !== e7 ? null === (o6 = s6._$Co) || void 0 === o6 ? void 0 : o6[e7] : s6._$Cl;
  const d4 = u(i6) ? void 0 : i6._$litDirective$;
  return (null == r5 ? void 0 : r5.constructor) !== d4 && (null === (n7 = null == r5 ? void 0 : r5._$AO) || void 0 === n7 || n7.call(r5, false), void 0 === d4 ? r5 = void 0 : (r5 = new d4(t5), r5._$AT(t5, s6, e7)), void 0 !== e7 ? (null !== (l6 = (h4 = s6)._$Co) && void 0 !== l6 ? l6 : h4._$Co = [])[e7] = r5 : s6._$Cl = r5), void 0 !== r5 && (i6 = N(t5, r5._$AS(t5, i6.values), r5, e7)), i6;
}
var S2 = class {
  constructor(t5, i6) {
  ...
  u(t5) {
    var i6;
    const { el: { content: s6 }, parts: e7 } = this._$AD, o6 = (null !== (i6 = null == t5 ? void 0 : t5.creationScope) && void 0 !== i6 ? i6 : r3).importNode(s6, true);
    C.currentNode = o6;
    let n7 = C.nextNode(), l6 = 0, h4 = 0, d4 = e7[0];
    for (; void 0 !== d4; ) {
      if (l6 === d4.index) {
        let i7;
        2 === d4.type ? i7 = new M(n7, n7.nextSibling, this, t5) : 1 === d4.type ? i7 = new d4.ctor(n7, d4.name, d4.strings, this, t5) : 6 === d4.type && (i7 = new z(n7, this, t5)), this._$AV.push(i7), d4 = e7[++h4];
      }
      l6 !== (null == d4 ? void 0 : d4.index) && (n7 = C.nextNode(), l6++);
    }
...
var M = class {
  constructor(t5, i6, s6, e7) {
    var o6;
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t5, this._$AB = i6, this._$AM = s6, this.options = e7, this._$Cp = null === (o6 = null == e7 ? void 0 : e7.isConnected) || void 0 === o6 || o6;
  }
  get _$AU() {
    var t5, i6;
  ...
  g(t5) {
    var i6;
    const { values: s6, _$litType$: e7 } = t5, o6 = "number" == typeof e7 ? this._$AC(t5) : (void 0 === e7.el && (e7.el = V.createElement(e7.h, this.options)), e7);
    if ((null === (i6 = this._$AH) || void 0 === i6 ? void 0 : i6._$AD) === o6)
      this._$AH.v(s6);
    else {
      const t6 = new S2(o6, this), i7 = t6.u(this.options);
      t6.v(s6), this.$(i7), this._$AH = t6;
    }
  }
  _$AC(t5) {
  ...
  T(t5) {
    ...
    let s6, e7 = 0;
    for (const o6 of t5)
      e7 === i6.length ? i6.push(s6 = new M(this.k(d2()), this.k(d2()), this, this.options)) : s6 = i6[e7], s6._$AI(o6), e7++;
...
var R = class {
  constructor(t5, i6, s6, e7, o6) {
    this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t5, this.name = i6, this._$AM = e7, this.options = o6, s6.length > 2 || "" !== s6[0] || "" !== s6[1] ? (this._$AH = Array(s6.length - 1).fill(new String()), this.strings = s6) : this._$AH = A;
  }
  get tagName() {
  ...
  _$AI(t5, i6 = this, s6, e7) {
    ...
    if (void 0 === o6)
      ...
      for (t5 = o6[0], l6 = 0; l6 < o6.length - 1; l6++)
        h4 = N(this, e8[s6 + l6], i6, l6), h4 === T && (h4 = this._$AH[l6]), n7 || (n7 = !u(h4) || h4 !== this._$AH[l6]), h4 === A ? t5 = A : t5 !== A && (t5 += (null != h4 ? h4 : "") + o6[l6 + 1]), this._$AH[l6] = h4;
    }
    n7 && !e7 && this.j(t5);
  }
  j(t5) {
...
var L = class extends R {
  constructor(t5, i6, s6, e7, o6) {
    super(t5, i6, s6, e7, o6), this.type = 5;
  }
  _$AI(t5, i6 = this) {
    var s6;
    if ((t5 = null !== (s6 = N(this, t5, i6, 0)) && void 0 !== s6 ? s6 : A) === T)
      return;
    const e7 = this._$AH, o6 = t5 === A && e7 !== A || t5.capture !== e7.capture || t5.once !== e7.once || t5.passive !== e7.passive, n7 = t5 !== A && (e7 === A || o6);
    o6 && this.element.removeEventListener(this.name, this, e7), n7 && this.element.addEventListener(this.name, this, t5), this._$AH = t5;
  }
  handleEvent(t5) {
    var i6, s6;
...
var B = (t5, i6, s6) => {
  var e7, o6;
  const n7 = null !== (e7 = null == s6 ? void 0 : s6.renderBefore) && void 0 !== e7 ? e7 : i6;
  let l6 = n7._$litPart$;
  if (void 0 === l6) {
    const t6 = null !== (o6 = null == s6 ? void 0 : s6.renderBefore) && void 0 !== o6 ? o6 : null;
    n7._$litPart$ = l6 = new M(i6.insertBefore(d2(), t6), t6, void 0, null != s6 ? s6 : {});
  }
...
var e4 = { attributeToProperty: h3._$AK, changedProperties: h3._$AL };
...
var { I: l4 } = Z;
var n5 = (o6, l6) => void 0 === l6 ? void 0 !== (null == o6 ? void 0 : o6._$litType$) : (null == o6 ? void 0 : o6._$litType$) === l6;
var v2 = (o6) => null == o6 ? void 0 : o6._$litDirective$;

// node_modules/lit-html/private-ssr-support.js
var r4 = { boundAttributeSuffix: Z.O, marker: Z.P, markerMatch: Z.A, HTML_RESULT: Z.C, getTemplateHtml: Z.M, overrideDirectiveResolve: (e7, t5) => class extends e7 {
  _$AS(e8, r5) {
    return t5(this, r5);
  }
}, setDirectiveClass(e7, t5) {
  e7._$litDirective$ = t5;
}, getAttributePartCommittedValue: (e7, r5, a3) => {
  let i6 = T;
  return e7.j = (e8) => i6 = e8, e7._$AI(r5, e7, a3), i6;
}, connectedDisconnectable: (e7) => ({ ...e7, _$AU: true }), resolveDirective: Z.R, AttributePart: Z.V, PropertyPart: Z.U, BooleanAttributePart: Z.H, EventPart: Z.N, ElementPart: Z.F, TemplateInstance: Z.L, isIterable: Z.D, ChildPart: Z.I };

// node_modules/@lit-labs/ssr-client/lib/hydrate-lit-html.js
var { TemplateInstance: l5, isIterable: i4, resolveDirective: s5, ChildPart: c3, ElementPart: d3 } = r4;
var u2 = (e7) => {
  const t5 = new Uint32Array(2).fill(5381);
  for (const r6 of e7.strings)
    for (let e8 = 0; e8 < r6.length; e8++)
      t5[e8 % 2] = 33 * t5[e8 % 2] ^ r6.charCodeAt(e8);
...
var decode_data_xml_default = new Uint16Array(
  "\u0200aglq	\x1B\u026D\0\0p;\u4026os;\u4027t;\u403Et;\u403Cuot;\u4022".split("").map((c4) => c4.charCodeAt(0))
);
...
var Tokenizer = class {
  ...
  _matchNamedCharacterReference(cp) {
    ...
    for (let i6 = 0, current = decode_data_html_default[0]; i6 >= 0; cp = this._consume()) {
      i6 = determineBranch(decode_data_html_default, current, i6 + 1, cp);
      if (i6 < 0)
        break;
      excess += 1;
      current = decode_data_html_default[i6];
      ...
      if (masked) {
        ...
        if (cp !== CODE_POINTS.SEMICOLON && this._isCharacterReferenceInAttribute() && isEntityInAttributeInvalidEnd2(this.preprocessor.peek(1))) {
          ...
          result = valueLength === 0 ? [decode_data_html_default[i6] & ~BinTrieFlags.VALUE_LENGTH] : valueLength === 1 ? [decode_data_html_default[++i6]] : [decode_data_html_default[++i6], decode_data_html_default[++i6]];
          excess = 0;
  ...
  _stateNamedCharacterReference(cp) {
    ...
    if (this._ensureHibernation()) {
      ...
      for (let i6 = 0; i6 < matchResult.length; i6++) {
        this._flushCodePointConsumedAsCharacterReference(matchResult[i6]);
      }
...
var OpenElementStack = class {
  ...
  _indexOfTagNames(tagNames, namespace) {
    for (let i6 = this.stackTop; i6 >= 0; i6--) {
      if (tagNames.includes(this.tagIDs[i6]) && this.treeAdapter.getNamespaceURI(this.items[i6]) === namespace) {
        return i6;
      }
    }
    return -1;
  ...
  hasInScope(tagName) {
    for (let i6 = this.stackTop; i6 >= 0; i6--) {
      ...
      const ns = this.treeAdapter.getNamespaceURI(this.items[i6]);
...
function stopParsing(p3, token) {
  ...
  if (token.location) {
    ...
    for (let i6 = p3.openElements.stackTop; i6 >= target; i6--) {
      p3._setEndLocation(p3.openElements.items[i6], token);
    }
...
function listItemStartTagInBody(p3, token) {
  p3.framesetOk = false;
  const tn = token.tagID;
  for (let i6 = p3.openElements.stackTop; i6 >= 0; i6--) {
    const elementId = p3.openElements.tagIDs[i6];
    ...
    if (elementId !== TAG_ID.ADDRESS && elementId !== TAG_ID.DIV && elementId !== TAG_ID.P && p3._isSpecialElement(p3.openElements.items[i6], elementId)) {
      break;
    }
  }
  if (p3.openElements.hasInButtonScope(TAG_ID.P)) {
...
function genericEndTagInBody(p3, token) {
  ...
  for (let i6 = p3.openElements.stackTop; i6 > 0; i6--) {
    const element = p3.openElements.items[i6];
    const elementId = p3.openElements.tagIDs[i6];
    if (tid === elementId && (tid !== TAG_ID.UNKNOWN || p3.treeAdapter.getTagName(element) === tn)) {
      ...
      if (p3.openElements.stackTop >= i6)
        p3.openElements.shortenToLength(i6);
      break;
    }
...
function tokenInTableText(p3, token) {
  ...
  if (p3.hasNonWhitespacePendingCharacterToken) {
    for (; i6 < p3.pendingCharacterTokens.length; i6++) {
      tokenInTable(p3, p3.pendingCharacterTokens[i6]);
    }
  } else {
    for (; i6 < p3.pendingCharacterTokens.length; i6++) {
      p3._insertCharacters(p3.pendingCharacterTokens[i6]);
    }
  }
  p3.insertionMode = p3.originalInsertionMode;
  p3._processToken(token);
...
var i5 = class extends i3 {
  render() {
  }
  update(e7) {
    const r5 = e7.parentNode;
    if ("function" == typeof r5.renderLight)
      return r5.renderLight();
  }
};
i5.t = true;
var o5 = e5(i5);
var n6 = (e7) => {
  var r5;
  return null === (r5 = v2(e7)) || void 0 === r5 ? void 0 : r5.t;
};
...
var { getTemplateHtml, marker, markerMatch, boundAttributeSuffix, overrideDirectiveResolve, setDirectiveClass, getAttributePartCommittedValue, resolveDirective, AttributePart, PropertyPart, BooleanAttributePart, EventPart, connectedDisconnectable } = r4;
var patchedDirectiveCache = /* @__PURE__ */ new Map();
var patchIfDirective = (value) => {
  const directiveCtor = v2(value);
...
function* renderValue(value, renderInfo) {
  ...
  if (n6(value)) {
    ...
    value = resolveDirective(connectedDisconnectable({ type: t3.CHILD }), value);
  }
  if (value != null && n5(value)) {
    yield `<!--lit-part ${u2(value)}-->`;
    yield* renderTemplateResult(value, renderInfo);
  } else {
    yield `<!--lit-part-->`;
    if (value === void 0 || value === null || value === A || value === T) {
...
var LitElementRenderer = class extends ElementRenderer {
  ...
  connectedCallback() {
    ...
    d.prototype.update.call(this.element);
  }
...
// index.js
var wrangler_lit_default = {
  async fetch() {
    const result = render(x`<p>Hello world</p>`);
...
export {
  wrangler_lit_default as default
};
